...
this["templates"]["playlist"]["track"]["tmpl"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  buffer += "\"><i class=\"fa fa-download\"></i>";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.free : depth0), {"name":"if","hash":{},"fn":this.program(3, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "</a>\n  </div>\n  <div class=\"info\">\n    <div class=\"title";
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "\">";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.titleScrolling : depth0), {"name":"if","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  ...
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.titleScrolling : depth0), {"name":"if","hash":{},"fn":this.program(9, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "</div>\n    <div class=\"artist\">";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.artistScrolling : depth0), {"name":"if","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
